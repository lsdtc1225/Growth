...
<jsp:setProperty property="postScore" name="rubricDisplayBean" value="Y"/>
        ...
        <c:choose>
                    ...
                    <form action="newAssignmentSaveAction.jsp" method="post">
                        ...
                        <select name="rubricID">
                            <c:forEach var="rubricDTO" items="${rubricDisplayBean.rubricList}" varStatus="rowCounter">
                                <option value="<c:out value="${rubricDTO.rubricID}" />" ><c:out value="${rubricDTO.rubricName}" /></option>
                            </c:forEach>
                        </select>
                        <br>
            ...
            <c:otherwise>
                <div id = "form">
                    ...
                    <br>
                    <a href="postRubricBasedSetup.jsp?cID=<c:out value="${courseBean.courseDTO.courseID}" />">Go to Setup Post Rubric</a>
                    <br>
