...
<html>
    ...
    <body>
        ...
        <div id = "form">
            <h3>Create Final Rubric</h3>
            <form action="postRubricBasedSetup.jsp" method="post">
                <input type="hidden" name="numberofSLOSubmitted" value="true" />
                Name for this rubric: 
                <c:choose>
                    <c:when test="${!param.numberofSLOSubmitted}">
                        <input type="text" name="rubricName" value="Rubric 1" /><br>
                    </c:when>
                    <c:otherwise>
                        <input type="text" name="rubricName" value="${param.rubricName}" /><br>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <input type="text" name="numberOfSLO" size="1" value="<c:out value="${param.numberOfSLO}" />"/><br>
                    </c:otherwise>
                </c:choose>
                ...
                <c:choose>
                    <c:when test="${param.yesWeights}">
                        <form action="CreateRubric" method="POST">
                            <input type="hidden" name="postScore" value="Y" />
                            ...
                            <table border="1">
                                ...
                                <c:forEach var="i" begin="1" end="${param.numberOfSLO}" step="1" varStatus ="status">
                                    <tr>
                                        ...
                                        <td><textarea name="SLODesc_${i}" ROWS=3 COLS=30 ></textarea></td>
                                    </tr>
